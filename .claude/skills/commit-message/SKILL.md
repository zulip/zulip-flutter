---
name: commit-message
description: "Conventions for writing a git commit message in this repo — summary-line format, where the Fixes line goes, body content, and how to split commits. Use whenever you are about to write or edit a commit message: before running `git commit`, when amending or rewording a commit, or when preparing commits for a PR."
---
...
- **Each commit is one minimal coherent idea** —
  ...
  commits *before* the feature commit.
