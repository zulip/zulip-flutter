...
The `.g.dart` file (generated by `build_runner`) is referenced via `part 'foo.g.dart';`. After editing, run `dart run build_runner build --delete-conflicting-outputs` to regenerate.
