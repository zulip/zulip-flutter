  ...
  group('edit message', () {
    ...
    void doSmokeTest({required Narrow narrow, required _EditInteractionStart start}) {
      ...
      testWidgets(description, (tester) async {
        ...
        // TODO could also check that quote-and-reply works
    ...
    doSmokeTest(narrow: channelNarrow, start: _EditInteractionStart.actionSheet);
    doSmokeTest(narrow: topicNarrow,   start: _EditInteractionStart.actionSheet);
    doSmokeTest(narrow: dmNarrow,      start: _EditInteractionStart.actionSheet);
    doSmokeTest(narrow: channelNarrow, start: _EditInteractionStart.restoreFailedEdit);
    doSmokeTest(narrow: topicNarrow,   start: _EditInteractionStart.restoreFailedEdit);
    doSmokeTest(narrow: dmNarrow,      start: _EditInteractionStart.restoreFailedEdit);
    ...
    void doTestInterruptComposingFromActionSheet({required Narrow narrow}) {
    ...
    doTestInterruptComposingFromActionSheet(narrow: channelNarrow);
    doTestInterruptComposingFromActionSheet(narrow: topicNarrow);
    doTestInterruptComposingFromActionSheet(narrow: dmNarrow);
    ...
    doTestInterruptComposingFromFailedEdit(narrow: topicNarrow);
    doTestInterruptComposingFromFailedEdit(narrow: dmNarrow);
    ...
    void doTestFetchRawContentFails({required Narrow narrow}) {
    ...
    doTestFetchRawContentFails(narrow: channelNarrow);
    doTestFetchRawContentFails(narrow: topicNarrow);
    doTestFetchRawContentFails(narrow: dmNarrow);
    ...
    doTestCancel(narrow: channelNarrow, duringFetchRawContentRequest: false);
    doTestCancel(narrow: topicNarrow,   duringFetchRawContentRequest: false);
    doTestCancel(narrow: dmNarrow,      duringFetchRawContentRequest: false);
    doTestCancel(narrow: channelNarrow, duringFetchRawContentRequest: true);
    doTestCancel(narrow: topicNarrow,   duringFetchRawContentRequest: true);
    doTestCancel(narrow: dmNarrow,      duringFetchRawContentRequest: true);
    doTestCancel(narrow: channelNarrow, start: _EditInteractionStart.restoreFailedEdit);
    doTestCancel(narrow: topicNarrow,   start: _EditInteractionStart.restoreFailedEdit);
    doTestCancel(narrow: dmNarrow,      start: _EditInteractionStart.restoreFailedEdit);
  });
}
