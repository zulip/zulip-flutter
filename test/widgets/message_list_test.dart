...
void main() {
  ...
  group('app bar', () {
    ...
    testWidgets('search button on combined feed navigates to search page', (tester) async {
      ...
      check(pushedRoutes).single.isA<WidgetRoute>().page
        .isA<MessageListPage>()
        .initNarrow.equals(SearchNarrow(filters: const []));
    });
  ...
  group('no-messages placeholder', () {
    ...
    testWidgets('Search, empty filters', (tester) async {
      await setupMessageListPage(tester, narrow: SearchNarrow(filters: const []));
  ...
  group('Search page', () {
    ...
    Condition<Object?> isSearchRequest(SearchNarrow narrow) {
