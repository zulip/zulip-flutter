...
void main() {
  ...
  group("buildTitle's willCenterTitle agrees with Material AppBar", () {
    ...
    /// Build a [ZulipAppBar]; return what `willCenterTitle` in `buildTitle` said.
    Future<bool> ours(WidgetTester tester, {
      ...
      check(find.byType(ZulipAppBar)).findsOne();
    ...
    void doTest(String description, bool expectedWillCenter, {
      ...
      testWidgets(description, (tester) async {
        ...
        check(await ours(tester,
            paramValue: paramValue,
            themeValue: themeValue,
            actions: actions))
        ..equals(await material(tester,
            paramValue: paramValue,
            themeValue: themeValue,
            actions: actions))
