...
class ContentExample {
  ...
  static final inlineImage = ContentExample.inline(
    ...
    InlineImageNode(
      loading: false,
      src: InlineImageNodeSrcThumbnail(ImageThumbnailLocator(animated: false,
  ...
  static final inlineImageLoading = ContentExample.inline(
    ...
    InlineImageNode(
      loading: true,
      src: InlineImageNodeSrcOther('/path/to/spinner.png'),
      alt: 'example image',
  ...
  static final inlineImageAnimated = ContentExample.inline(
    ...
    InlineImageNode(
      loading: false,
      src: InlineImageNodeSrcThumbnail(ImageThumbnailLocator(animated: true,
