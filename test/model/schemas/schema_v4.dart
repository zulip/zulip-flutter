...
class GlobalSettings extends Table
  ...
  late final GeneratedColumn<String> browserPreference =
      GeneratedColumn<String>('browser_preference', aliasedName, false,
          type: DriftSqlType.string,
          requiredDuringInsert: false,
          defaultValue: const Variable('unset'));
  @override
  ...
  GlobalSettingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return GlobalSettingsData(
      themeSetting: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}theme_setting'])!,
      browserPreference: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}browser_preference'])!,
    );
  }
...
class GlobalSettingsData extends DataClass
  ...
  factory GlobalSettingsData.fromJson(Map<String, dynamic> json,
    ...
    return GlobalSettingsData(
      ...
      browserPreference: serializer.fromJson<String>(json['browserPreference']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
  ...
  GlobalSettingsData copyWith(
          {String? themeSetting, String? browserPreference}) =>
      GlobalSettingsData(
