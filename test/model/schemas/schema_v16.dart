...
class Accounts extends Table with TableInfo<Accounts, AccountsData> {
  ...
  late final GeneratedColumn<int> possibleLegacyPushToken =
      GeneratedColumn<int>(
        ...
        requiredDuringInsert: false,
        $customConstraints:
            'NOT NULL DEFAULT 1 CHECK (possible_legacy_push_token IN (0, 1))',
...
class AccountsData extends DataClass implements Insertable<AccountsData> {
  ...
  final int possibleLegacyPushToken;
  const AccountsData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['possible_legacy_push_token'] = Variable<int>(possibleLegacyPushToken);
    return map;
  }
  ...
  factory AccountsData.fromJson(
    ...
    return AccountsData(
      ...
      possibleLegacyPushToken: serializer.fromJson<int>(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'possibleLegacyPushToken': serializer.toJson<int>(
        possibleLegacyPushToken,
      ),
    };
  }
...
class AccountsCompanion extends UpdateCompanion<AccountsData> {
  ...
  final Value<int> possibleLegacyPushToken;
  ...
  static Insertable<AccountsData> custom({
    ...
    Expression<int>? possibleLegacyPushToken,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  AccountsCompanion copyWith({
    ...
    Value<int>? possibleLegacyPushToken,
  }) {
    return AccountsCompanion(
      id: id ?? this.id,
      realmUrl: realmUrl ?? this.realmUrl,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (possibleLegacyPushToken.present) {
      map['possible_legacy_push_token'] = Variable<int>(
