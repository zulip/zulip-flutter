...
void main() {
  test('handleSavedSnippetsEvent', () {
    final store = eg.store(initialSnapshot: eg.initialSnapshot(
      savedSnippets: [eg.savedSnippet(id: 101)]));

    store.handleEvent(SavedSnippetsAddEvent(id: 1,savedSnippet:
      eg.savedSnippet(
        id: 102,
        title: 'foo title',
        content: 'foo content',
    ...
    store.handleEvent(SavedSnippetsRemoveEvent(id: 3, savedSnippetId: 101));
    check(store).savedSnippets.values.single.id.equals(102);

    store.handleEvent(SavedSnippetsUpdateEvent(id: 2, savedSnippet:
      eg.savedSnippet(
        id: 102,
        title: 'bar title',
        content: 'bar content',
