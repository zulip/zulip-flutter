...
enum MessageEditState {
  ...
  static bool _isResovled(String topic) {
    return _resolvedTopicPrefixRe.matchAsPrefix(topic) != null;
  }
  ...
  static bool areSameTopic(String topic, String prevTopic) {
    ...
    if (_isResovled(topic) && topic.substring(2) == prevTopic) {
      return true;
    }

    if (_isResovled(prevTopic) && prevTopic.substring(2) == topic) {
      return true;
    }
