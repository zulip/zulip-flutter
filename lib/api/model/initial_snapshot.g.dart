...
InitialSnapshot _$InitialSnapshotFromJson(
  ...
  serverReportMessageTypes:
      (json['server_report_message_types'] as List<dynamic>?)
          ?.map(
            (e) => ServerReportMessageType.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
);
...
ServerReportMessageType _$ServerReportMessageTypeFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ServerReportMessageTypeToJson(
  ServerReportMessageType instance,
