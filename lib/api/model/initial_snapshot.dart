...
class InitialSnapshot {
  ...
  final List<ServerReportMessageType>? serverReportMessageTypes; // TODO(server-12)
...
/// in <https://zulip.com/api/register-queue>.
@JsonSerializable(fieldRename: FieldRename.snake)
class ServerReportMessageType {
  final String key;
  final String name;

  ServerReportMessageType({
    required this.key,
    required this.name,
  });

  factory ServerReportMessageType.fromJson(Map<String, dynamic> json) =>
    _$ServerReportMessageTypeFromJson(json);

  Map<String, dynamic> toJson() => _$ServerReportMessageTypeToJson(this);
}
