...
mixin _MessageSequence {
  ...
  ///
  /// When [isMiddleMessage] is true, [message] is assumed to divide
  /// [messages] into the top slice and the bottom slice.  See [middleMessage].
  ///
  ...
  void _processMessage(int index) {
    ...
    _addItemsForMessage(message,
      isMiddleMessage: index == middleMessage,
