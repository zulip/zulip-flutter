...
class Topics extends PerAccountStoreBase with ChangeNotifier {
  ...
  /// Latest message ID of [topic] in the channel with ID [channelId].
  ///
  /// Returns `null` when either the topic doesn't exist or the topics for the
  /// channel are not fetched yet. To make sure the topics are already fetched,
  /// await [getChannelTopics] before calling this method.
