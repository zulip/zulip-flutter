...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    _NavigationBarButton button(HomePageTab tab, IconData icon) {
    ...
    final navigationBarButtons = {
      button(HomePageTab.inbox,          ZulipIcons.inbox),
      button(HomePageTab.channels,       ZulipIcons.hash_italic),
      // TODO(#1094): Users
      button(HomePageTab.directMessages, ZulipIcons.user),
...
class _LoadingPlaceholderPageState extends State<_LoadingPlaceholderPage> {
  ...
  void didChangeDependencies() {
    ...
    realmUrl = GlobalStoreWidget.of(context).getAccount(widget.accountId)!.realmUrl;
  }
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            IgnorePointer(
              ignoring: !showTryAnotherAccount,
              child: Opacity(opacity: showTryAnotherAccount ? 1 : 0,
                child: Padding(
...
/// A menu button controlling the selected [HomePageTab] on the bottom nav bar.
