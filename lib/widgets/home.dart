...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ZulipAppBar(titleSpacing: 16, title: Text(_currentTabTitle)),
      body: Stack(
        children: [
...
class _LoadingPlaceholderPageState extends State<_LoadingPlaceholderPage> {
  ...
  Widget build(BuildContext context) {
    final zulipLocalizations = ZulipLocalizations.of(context);
    final realmUrl =
        GlobalStoreWidget.of(context).getAccount(widget.accountId)!.realmUrl;
...
class _NavigationBarButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = WidgetStateColor.fromMap({
      ...
      ~WidgetState.pressed:
          selected ? designVariables.iconSelected : designVariables.icon,
    });
  ...
  Widget build(BuildContext context) {
    ...
    final buttonStyle = TextButton.styleFrom(
      ...
      backgroundColor: WidgetStateColor.fromMap({
        WidgetState.hovered: designVariables.bgMenuButtonActive.withFadedAlpha(
          0.5,
        ),
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 19, height: 26 / 19).merge(
                    weightVariableTextStyle(
                      context,
                      wght: selected ? 600 : 400,
                    ),
                  ),
                ),
              ),
...
class _CombinedProfileButton extends StatelessWidget {
  const _CombinedProfileButton();
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                ZulipLocalizations.of(context).mainMenuMyProfile,
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).push(MaterialWidgetRoute(page: const ChooseAccountPage()));
              },
            ),
          ],
        ),
