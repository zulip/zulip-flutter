  ...
  static Future<void> markNarrowAsRead(BuildContext context, Narrow narrow) async {
    ...
    if (shouldShowConfirmationDialog) {
      ...
      final didConfirm = showSuggestedActionDialog(context: context,
        ...
        message: displayCount == null
          ? zulipLocalizations.markAllAsReadConfirmationDialogMessageNoCount
          : zulipLocalizations.markAllAsReadConfirmationDialogMessage(displayCount),
