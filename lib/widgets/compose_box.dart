    ...
    final time = await showTimePicker(
      ...
      builder: (context, child) {
        final themed = Theme(
          ...
          child: child!);
        return switch (twentyFourHourTimeMode) {
          TwentyFourHourTimeMode.localeDefault => themed,
          TwentyFourHourTimeMode.twelveHour => MediaQuery(
            data: MediaQuery.of(context).copyWith(
              alwaysUse24HourFormat: false),
            child: themed),
          TwentyFourHourTimeMode.twentyFourHour => MediaQuery(
            data: MediaQuery.of(context).copyWith(
