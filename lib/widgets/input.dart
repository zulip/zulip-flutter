...
class PopupMenuList extends StatelessWidget {
  ...
  ///
  /// See [verticalShadowInset], which is related.
  static const verticalPadding   = EdgeInsets.symmetric(vertical: 2);

  /// The horizontal content padding.
  static const horizontalPadding = EdgeInsets.symmetric(horizontal: 2);
  ...
  static const verticalShadowInset = EdgeInsets.symmetric(vertical: 6);
      ...
      child: Padding(
        ...
        child: ConstrainedBox(
          ...
          child: InsetShadowBox(
            top: verticalShadowInset.top, bottom: verticalShadowInset.bottom,
            color: designVariables.contextMenuBg,
