...
abstract final class ZulipIcons {
  ...
  static const IconData remove = IconData(0xf114, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "send".
  static const IconData send = IconData(0xf115, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "share".
  static const IconData share = IconData(0xf116, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "share_ios".
  static const IconData share_ios = IconData(0xf117, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "smile".
  static const IconData smile = IconData(0xf118, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "star".
  static const IconData star = IconData(0xf119, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "star_filled".
  static const IconData star_filled = IconData(0xf11a, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "topic".
  static const IconData topic = IconData(0xf11b, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "unmute".
  static const IconData unmute = IconData(0xf11c, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "user".
  static const IconData user = IconData(0xf11d, fontFamily: "Zulip Icons");
