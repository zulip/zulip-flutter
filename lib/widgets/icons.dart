...
abstract final class ZulipIcons {
  ...
  static const IconData group_dm_3 = IconData(0xf11a, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_4".
  static const IconData group_dm_4 = IconData(0xf11b, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_5".
  static const IconData group_dm_5 = IconData(0xf11c, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_6".
  static const IconData group_dm_6 = IconData(0xf11d, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_7".
  static const IconData group_dm_7 = IconData(0xf11e, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_8".
  static const IconData group_dm_8 = IconData(0xf11f, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "group_dm_9".
  static const IconData group_dm_9 = IconData(0xf120, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "hash_italic".
  static const IconData hash_italic = IconData(0xf121, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "hash_sign".
  static const IconData hash_sign = IconData(0xf122, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "image".
  static const IconData image = IconData(0xf123, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "inbox".
  static const IconData inbox = IconData(0xf124, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "info".
  static const IconData info = IconData(0xf125, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "inherit".
  static const IconData inherit = IconData(0xf126, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "language".
  static const IconData language = IconData(0xf127, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "link".
  static const IconData link = IconData(0xf128, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "lock".
  static const IconData lock = IconData(0xf129, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "menu".
  static const IconData menu = IconData(0xf12a, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "message_checked".
  static const IconData message_checked = IconData(0xf12b, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "message_feed".
  static const IconData message_feed = IconData(0xf12c, fontFamily: "Zulip Icons", matchTextDirection: true);

  /// The Zulip custom icon "more_horizontal".
  static const IconData more_horizontal = IconData(0xf12d, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "mute".
  static const IconData mute = IconData(0xf12e, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "person".
  static const IconData person = IconData(0xf12f, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "pin".
  static const IconData pin = IconData(0xf130, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "pin_remove".
  static const IconData pin_remove = IconData(0xf131, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "plus".
  static const IconData plus = IconData(0xf132, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "read_receipts".
  static const IconData read_receipts = IconData(0xf133, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "remove".
  static const IconData remove = IconData(0xf134, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "search".
  static const IconData search = IconData(0xf135, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "see_who_reacted".
  static const IconData see_who_reacted = IconData(0xf136, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "send".
  static const IconData send = IconData(0xf137, fontFamily: "Zulip Icons", matchTextDirection: true);

  /// The Zulip custom icon "settings".
  static const IconData settings = IconData(0xf138, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "share".
  static const IconData share = IconData(0xf139, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "share_ios".
  static const IconData share_ios = IconData(0xf13a, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "smile".
  static const IconData smile = IconData(0xf13b, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "star".
  static const IconData star = IconData(0xf13c, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "star_filled".
  static const IconData star_filled = IconData(0xf13d, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "three_person".
  static const IconData three_person = IconData(0xf13e, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "topic".
  static const IconData topic = IconData(0xf13f, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "topics".
  static const IconData topics = IconData(0xf140, fontFamily: "Zulip Icons", matchTextDirection: true);

  /// The Zulip custom icon "trash".
  static const IconData trash = IconData(0xf141, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "two_person".
  static const IconData two_person = IconData(0xf142, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "unmute".
  static const IconData unmute = IconData(0xf143, fontFamily: "Zulip Icons");
