...
abstract final class ZulipIcons {
  ...
  static const IconData arrow_left_right = IconData(0xf103, fontFamily: "Zulip Icons", matchTextDirection: true);

  /// The Zulip custom icon "arrow_right".
  static const IconData arrow_right = IconData(0xf104, fontFamily: "Zulip Icons", matchTextDirection: true);
  ...
  static const IconData chevron_right = IconData(0xf10f, fontFamily: "Zulip Icons", matchTextDirection: true);
  ...
  static const IconData send = IconData(0xf12f, fontFamily: "Zulip Icons", matchTextDirection: true);
  ...
  static const IconData topics = IconData(0xf138, fontFamily: "Zulip Icons", matchTextDirection: true);
