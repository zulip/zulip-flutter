...
abstract final class ZulipIcons {
  ...
  static const IconData eye = IconData(0xf10e, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "eye_off".
  static const IconData eye_off = IconData(0xf10f, fontFamily: "Zulip Icons");
  ...
  static const IconData person = IconData(0xf120, fontFamily: "Zulip Icons");
  ...
  static const IconData two_person = IconData(0xf12b, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "unmute".
  static const IconData unmute = IconData(0xf12c, fontFamily: "Zulip Icons");
