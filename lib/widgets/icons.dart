...
abstract final class ZulipIcons {
  ...
  static const IconData chevron_right = IconData(0xf108, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "clock".
  static const IconData clock = IconData(0xf109, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "contacts".
  static const IconData contacts = IconData(0xf10a, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "copy".
  static const IconData copy = IconData(0xf10b, fontFamily: "Zulip Icons");
