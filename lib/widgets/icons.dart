...
abstract final class ZulipIcons {
  ...
  static const IconData send = IconData(0xf111, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "star_filled".
  static const IconData star_filled = IconData(0xf112, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "topic".
  static const IconData topic = IconData(0xf113, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "unmute".
  static const IconData unmute = IconData(0xf114, fontFamily: "Zulip Icons");

  /// The Zulip custom icon "user".
  static const IconData user = IconData(0xf115, fontFamily: "Zulip Icons");
