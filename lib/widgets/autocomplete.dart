  ...
  void _onTapOption(BuildContext context, ComposeAutocompleteResult option) {
    ...
    switch (option) {
      ...
      case ChannelLinkAutocompleteResult(:final channelId):
        ...
        replacementString = store.effectiveTopicsPolicy(channelId) == .emptyTopicOnly
          // TODO(#1805) language-appropriate space character; check active keyboard?
          //   (maybe handle centrally in `controller`)
          ? '${channelLink(channel, store: store)} '
  ...
  Widget build(BuildContext context) {
    ...
    switch (option) {
      case TopicLinkAutocompleteChannelResult():
        ...
        labelSpan = TextSpan(text: channel.name);
      ...
      case TopicLinkAutocompleteTopicResult(:var topic):
        ...
        labelSpan = topicLabelSpan(
          context: context,
          topic: topic,
          fontSize: labelStyle.fontSize!,
          color: labelStyle.color!);
        if (option is TopicLinkAutocompleteNewTopicResult) {
      ...
      child: Padding(
        ...
        child: Padding(
          ...
          child: Row(spacing: 10, children: [
            ...
            Expanded(child: Text.rich(labelSpan, overflow: .ellipsis, style: labelStyle)),
