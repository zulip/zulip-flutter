...
class DesignVariables extends ThemeExtension<DesignVariables> {
  static final light = DesignVariables._(
    ...
    btnBgVarSolidIntInfoActive: const Color(0xff1e41d3),
    ...
    btnLabelVarTextIntInfo: const Color(0xff2347c6),
    btnLabelVarSubtleIntDanger: const Color(0xffac0508),
    btnLabelVarSubtleIntInfo: const Color(0xff1027a6),
    btnLabelVarSubtleIntWarning: const Color(0xff764607),
  ...
  static final dark = DesignVariables._(
    ...
    btnLabelVarTextIntInfo: const Color(0xff84a8fd),
    btnLabelVarSubtleIntDanger: const Color(0xffff8b7c),
    btnLabelVarSubtleIntInfo: const Color(0xff97b6fe),
    btnLabelVarSubtleIntWarning: const Color(0xfff8b325),
  ...
  DesignVariables._({
    ...
    required this.btnBgVarSolidIntInfoActive,
    required this.btnBgVarSolidIntInfoNormal,
    required this.btnBgVarSolidIntWarningActive,
    ...
    required this.btnLabelVarTextIntInfo,
    required this.btnLabelVarSubtleIntDanger,
    required this.btnLabelVarSubtleIntInfo,
    required this.btnLabelVarSubtleIntWarning,
  ...
  final Color btnBgVarSolidIntInfoActive;
  final Color btnBgVarSolidIntInfoNormal;
  final Color btnBgVarSolidIntWarningActive;
  ...
  final Color btnLabelVarTextIntInfo;
  final Color btnLabelVarSubtleIntDanger;
  final Color btnLabelVarSubtleIntInfo;
  final Color btnLabelVarSubtleIntWarning;
  ...
  DesignVariables copyWith({
    ...
    Color? btnBgVarSolidIntInfoActive,
    Color? btnBgVarSolidIntInfoNormal,
    Color? btnBgVarSolidIntWarningActive,
    ...
    Color? btnLabelVarTextIntInfo,
    Color? btnLabelVarSubtleIntDanger,
    Color? btnLabelVarSubtleIntInfo,
    Color? btnLabelVarSubtleIntWarning,
    ...
    return DesignVariables._(
      ...
      btnBgVarSolidIntInfoActive: btnBgVarSolidIntInfoActive ?? this.btnBgVarSolidIntInfoActive,
      btnBgVarSolidIntInfoNormal: btnBgVarSolidIntInfoNormal ?? this.btnBgVarSolidIntInfoNormal,
      btnBgVarSolidIntWarningActive: btnBgVarSolidIntWarningActive ?? this.btnBgVarSolidIntWarningActive,
      ...
      btnLabelVarTextIntInfo: btnLabelVarTextIntInfo ?? this.btnLabelVarTextIntInfo,
      btnLabelVarSubtleIntDanger: btnLabelVarSubtleIntDanger ?? this.btnLabelVarSubtleIntDanger,
      btnLabelVarSubtleIntInfo: btnLabelVarSubtleIntInfo ?? this.btnLabelVarSubtleIntInfo,
      btnLabelVarSubtleIntWarning: btnLabelVarSubtleIntWarning ?? this.btnLabelVarSubtleIntWarning,
  ...
  DesignVariables lerp(DesignVariables other, double t) {
    ...
    return DesignVariables._(
      ...
      btnBgVarSolidIntInfoActive: Color.lerp(btnBgVarSolidIntInfoActive, other.btnBgVarSolidIntInfoActive, t)!,
      btnBgVarSolidIntInfoNormal: Color.lerp(btnBgVarSolidIntInfoNormal, other.btnBgVarSolidIntInfoNormal, t)!,
      btnBgVarSolidIntWarningActive: Color.lerp(btnBgVarSolidIntWarningActive, other.btnBgVarSolidIntWarningActive, t)!,
      ...
      btnLabelVarTextIntInfo: Color.lerp(btnLabelVarTextIntInfo, other.btnLabelVarTextIntInfo, t)!,
      btnLabelVarSubtleIntDanger: Color.lerp(btnLabelVarSubtleIntDanger, other.btnLabelVarSubtleIntDanger, t)!,
      btnLabelVarSubtleIntInfo: Color.lerp(btnLabelVarSubtleIntInfo, other.btnLabelVarSubtleIntInfo, t)!,
      btnLabelVarSubtleIntWarning: Color.lerp(btnLabelVarSubtleIntWarning, other.btnLabelVarSubtleIntWarning, t)!,
