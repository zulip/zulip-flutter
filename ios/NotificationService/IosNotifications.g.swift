...
enum IosNotificationsPigeonInternal {
...
enum IosNotificationSound: Int, CaseIterable {
...
struct NotificationContent: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: NotificationContent, rhs: NotificationContent) -> Bool {
    ...
    return IosNotificationsPigeonInternal.deepEquals(lhs.payload, rhs.payload)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("NotificationContent")
    IosNotificationsPigeonInternal.deepHash(value: payload, hasher: &hasher)
  }

  public var description: String {
    return "NotificationContent(payload: \(String(describing: payload)))"
  }
}
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct ImprovedNotificationContent: Hashable, CustomStringConvertible {
