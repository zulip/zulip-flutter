...
struct IosNotificationTapEvent: NotificationTapEvent {
  ...
  public var description: String {
    return "IosNotificationTapEvent(payload: \(String(describing: payload)))"
  }
}
...
struct AndroidNotificationTapEvent: NotificationTapEvent {
  ...
  static func == (lhs: AndroidNotificationTapEvent, rhs: AndroidNotificationTapEvent) -> Bool {
    ...
    return NotificationsPigeonInternal.deepEquals(lhs.dataUrl, rhs.dataUrl)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("AndroidNotificationTapEvent")
    NotificationsPigeonInternal.deepHash(value: dataUrl, hasher: &hasher)
  }

  public var description: String {
    return "AndroidNotificationTapEvent(dataUrl: \(String(describing: dataUrl)))"
  }
}
